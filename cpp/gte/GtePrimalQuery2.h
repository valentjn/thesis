...
public:
    ...
    //    0, P on the line
    //
    // Choice of N for Real of type BSNumber or BSRational with integer
    // storage UIntegerFP32<N>, for the first two ToLine functions.
    ...
    //    float      | BSNumber     |   18
    //    double     | BSNumber     |  132
    //    float      | BSRational   |  428
    //    double     | BSRational   | 3174
    ...
    //    float      | BSNumber     |    35
    //    double     | BSNumber     |   263
    //    float      | BSRational   |  4173
    //    double     | BSRational   | 31413
    // The query involves three calls of ToLine, so the numbers match those
    // of ToLine.
