...
//----------------------------------------------------------------------------
template <typename KeyType, typename ValueType>
MinHeap<KeyType, ValueType>& MinHeap<KeyType, ValueType>::operator=(
...
int MinHeap<KeyType, ValueType>::GetNumElements() const
{
    return mNumElements;
}
//----------------------------------------------------------------------------
template <typename KeyType, typename ValueType>
inline bool MinHeap<KeyType, ValueType>::GetMinimum(KeyType& key,
...
MinHeap<KeyType, ValueType>::Insert(KeyType const& key,
...
//----------------------------------------------------------------------------
template <typename KeyType, typename ValueType>
void MinHeap<KeyType, ValueType>::Update(Record* record,
    ValueType const& value)
{
