...
DarbouxFrame3<Real>::DarbouxFrame3(
    ParametricSurface<3, Real> const& surface)
    :
    mSurface(&surface)
{
}
...
void DarbouxFrame3<Real>::operator()(Real u, Real v, Vector3<Real>& position,
    Vector3<Real>& tangent0, Vector3<Real>& tangent1, Vector3<Real>& normal)
    const
{
...
//----------------------------------------------------------------------------
template <typename Real>
void DarbouxFrame3<Real>::GetPrincipalInformation(Real u, Real v,
    Real& curvature0, Real& curvature1,
    Vector3<Real>& direction0, Vector3<Real>& direction1) const
{
