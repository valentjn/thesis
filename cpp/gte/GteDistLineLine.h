...
//----------------------------------------------------------------------------
template <int N, typename Real>
typename DCPQuery<Real, Line<N, Real>, Line<N, Real>>::Result
DCPQuery<Real, Line<N, Real>, Line<N, Real>>::operator()(
    Line<N, Real> const& line0, Line<N, Real> const& line1)
{
    Result result;
