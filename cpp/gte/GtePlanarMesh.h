...
public:
    ...
    int GetContainingTriangle(Vector2<InputType> const& P,
        int startTriangle, std::set<int>& visited) const;
...
template <typename InputType, typename ComputeType, typename RationalType>
int PlanarMesh<InputType, ComputeType, RationalType>::
GetContainingTriangle(Vector2<InputType> const& P, int startTriangle,
...
//----------------------------------------------------------------------------
template <typename InputType, typename ComputeType, typename RationalType>
bool PlanarMesh<InputType, ComputeType, RationalType>::Contains(int triangle,
    Vector2<InputType> const& P) const
{
    Vector2<ComputeType> test{ P[0], P[1] };
