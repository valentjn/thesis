...
\begin{proposition}[%
  ...
  \begin{equation}
    ...
    \alpha^{(j)}_{(\ßk_T,\ßk'_{-T})} \varphi_{\ßk_T}(\vgp{\ßk'_T})
    = f_{\ßk'},\quad
    \ßk' = \ß0, \dotsc, \ß2^\ßl,
  \end{equation}
...
\begin{proof}
  ...
  \begin{align}
    ...
    \varphi_{\ßk_{T'}}(\vgp{\ßk'_{T'}}) \cdot
    \sum_{k_{t_j}=0}^{2^{l_{t_j}}}
      \alpha^{(j)}_{(\ßk_T,\ßk'_{-T})} \varphi_{k_{t_j}}(\gp{k'_{t_j}}).\\
    \intertext{%
      ...
      \alpha^{(j)}_\ßk \varphi_{k_{t_j}}(\gp{k'_{t_j}})
      %= ((L_{t_j})^{-1}
...
\begin{proof}
  ...
  $\sum_{\ßk=\ß0}^{\ß2^\ßl}
  \alpha^{(j)}_\ßk \varphi_{\ßk}(\vgp{\ßk'})
  = f_{\ßk'}$
