      ...
      \For{$j = 1, \dotsc, d$}
        ...
        \For{$\liset_\mathrm{pole} \in \liset/{\sim}$}
          \State{%
            ...
            \linop_{t_j}
            \Big[(\linout{\ßk}^{(j-1)})_{\ßk \in \liset_\mathrm{pole}}\Big]$%
          }
...
\begin{proposition}[%
  ...
  \begin{equation}
    ...
    \surplus{(\ßk_T,\ßk'_{-T})}^{(j)} \basis{\ßk_T}(\gp{\ßk'_T})
    = \fcnval{\ßk'},\quad
    \ßk' = \ß0, \dotsc, \ß2^\ßl,
  \end{equation}
