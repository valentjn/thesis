...
$\hierbspl{l,i}{p}{}$ as we have defined them in the last section.
...
\begin{figure}
  ...
  \caption{%
    Hierarchical cubic B-splines $\hierbspl{l',i'}{p}{}$
...
as the hierarchical basis functions $\hierbspl{l',i'}{p}{}$ are not
...
\begin{proof}
  ...
  Second, the hierarchical functions $\hierbspl{l',i'}{p}{\notaknot}$
...
not-a-knot B-spline $\hierbspl{l,0}{p}{\notaknot}$ left of
$\hierbspl{l,1}{p}{\notaknot}$.
B-splines $\hierbspl{l,i}{p}{\notaknot}$ with index $i < 0$
...
\begin{equation}
  ...
  \begin{cases}
    ...
    \hierbspl{l,1}{p}{\notaknot}(x)
    - \hierbspl{l,0}{p}{\notaknot}(x)
    \dfrac{\frac{\diff^2}{\dx^2} \hierbspl{l,1}{p}{\notaknot}(0)}%
    {\frac{\diff^2}{\dx^2} \hierbspl{l,0}{p}{\notaknot}(0)},&
    l \ge 2,\quad i = 1,\\
    \hierbspl{l,i}{p}{\notaknot}(x),&
    l \ge 2,\quad i \in \hiset{l} \setminus \{1, 2^l - 1\},\\
    \hierbspl{l,1}{p}{\modified,\notaknot}(1 - x),&
    l \ge 2,\quad i = 2^l - 1.
  \end{cases}
  \hspace*{-2mm}
\end{equation}
...
As before, we have to implement $\hierbspl{l,1}{p}{\modified,\notaknot}$
...
\begin{figure}
  ...
  \subcaptionbox{%
    $\hierbspl{l',i'}{p}{\clenshawcurtis,\notaknot}$,
    $\hierbspl{l',i'}{p}{\modified,\clenshawcurtis,\notaknot}$
...
\begin{equation}
  \frac{\diff^q}{\dx^q} \hierbspl{l,i}{p}{\ntrl}(x)
  = 0,\quad
  l \ge 1,\quad
  i \in \hiset{l},\quad
...
($j < i$) vanish if the interior of the support of $\hierbspl{l,i}{p}{}$
does not contain $x = 0$
(i.e., $i > \tfrac{p+1}{2}$).
The second half of the coefficients~($j > i$) vanishes analogously
if $1 \notin \interiorsupp \hierbspl{l,i}{p}{} \iff i < 2^l - \tfrac{p+1}{2}$.
