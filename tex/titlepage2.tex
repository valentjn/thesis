...
\begin{spacing}{1}
  ...
  \begin{center}
    \includegraphics[height=80mm]{title_1_without_text}
  \end{center}
...
\noindent
Compiled as version \getAndIncreaseCompileCounter{} on \currentTimeLong\\
Committed as \gitCommitHash{} on \gitCommitTimeLong
