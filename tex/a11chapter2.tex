...
\begin{proof}
  ...
  \begin{align}
    ...
    \intertext{%
      The first sum is the number $\setsize{\interior{\Omega}_{n,d}^\sparse}$
    ...
    &= \setsize{\interior{\Omega}_{n,d}^\sparse} + 2^d +
  ...
  (number $\setsize{I_\ß0}$ of corners of $\clint{\ß0, \ß1}$).
  ...
  In general, the innermost summand $\setsize{I_\ßl}$ can be calculated as
  $\setsize{I_\ßl}
