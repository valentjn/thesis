...
\begin{figure}
  ...
  \hfill%
  \subcaptionbox{%
    3D, $(t_1, t_2, t_3) = (2, 3, 1)$%
    \label{fig:chainDefinition3}%
  }[50mm]{%
...
\begin{SCfigure}
  ...
  \caption[%
    ...
    The interpolants $\fgintp{l}$ \emph{\textcolor{C0}{(blue)}}
    of the objective function \emph{\textcolor{C1}{(red)}}
    ...
    \emph{%
      (black dashed lines between \textcolor{C0}{blue} and
      \textcolor{C1}{red} dots)%
    }.
