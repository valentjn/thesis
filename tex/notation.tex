...
\newnotationcommandoptarg{1}{\vlinin}{\*u^{#1}}{u}{$\vlinin$}{
  Input of the linear operator $\linop$
}

\newcommand*{\linin}[2][]{u_{#2}^{#1}}

\newnotationcommandoptarg{1}{\vlinout}{\*y^{#1}}{y}{$\vlinout$}{
  Output of the linear operator $\linop$
}

\newcommand*{\linout}[2][]{y_{#2}^{#1}}
...
\newnotationcommandoptarg{2}{\fgset}{\Omega_{#2}^{#1}}{ÄΩl}{$\fgset{\*l}$}{
...
\newcommand*{\surplustilde}[2][]{\tilde{\alpha}_{#2}^{#1}}
...
\newcommand*{\interpcoefftilde}[2][]{\tilde{c}_{#2}^{#1}}
