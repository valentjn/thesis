...
\newnotationcommand[1]{\unitvec}{\*e_{#1}}{et}{$\unitvec{t}$}{
  $t$-th unit basis vector $:= (0, \dotsc, 0, 1, 0, \dotsc, 0) \in \real^d$
}
...
{$\eqclasses{\cdot}{\sim}$}{
  Set of equivalence classes for an equivalence relation $\sim$ on
  a set $\cdot$
}
...
\newnotationcommand[1]{\relindexset}{J_{#1}}{Jl}{$\relindexset{l}$}{
...
\newnotationcommand[1]{\fcnval}{f(\gp{#1})}{fli}{$\fcnval{\*l,\*i}$}{
...
\newcommand*{\surplustilde}[1]{\tilde{\alpha}_{#1}}
...
\newcommand*{\interpcoefftilde}[1]{\tilde{c}_{#1}}
...
\newcommand*{\hftbasis}[1]{\varphi_{#1}^{\hft}}
\newcommand*{\tiftbasis}[1]{\varphi_{#1}^{\tift}}

\newnotationcommand{\parentfcn}{\varphi}{Äφ}{$\parentfcn$}{
