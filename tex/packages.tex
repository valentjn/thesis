...
% (this is due to the cellspace package)
\csname msg_redirect_name:nnn\endcsname{siunitx}{moved-cellspace-column}{none}
...
% this warning will be patched soon according to egreg
% (the author of regexpatch)
