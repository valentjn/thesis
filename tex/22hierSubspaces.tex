...
%  (like hat functions $\hierbspl{l,i}{1}{}$ and higher-order B-splines)
...
For the hat function basis $\hierbspl{l,i}{1}{}$ and other basis types,
...
\begin{figure}
  \subcaptionbox{%
    Basis functions $\hierbspl{l',i'}{1}{}$ ($l' \le l$, $i' \in \hiset{l'}$)
...
\begin{proof}
  ...
  over $l$:
  If a linear combination of $\hierbspl{l',i'}{1}{}$ ($l' \le l$, $i' \in \hiset{l'}$)
  vanishes everywhere, then the coefficients of level $l$ must be zero,
  as otherwise the basis functions $\hierbspl{l,i'}{1}{}$ ($i' \in \hiset{l}$) would
  introduce kinks at $\gp{l,i'}$, which the zero function does not have.
  This means that we have a zero linear combination of $\hierbspl{l',i'}{1}{}$ for
