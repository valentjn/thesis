...
The entries of the state $\state_t \in \clint{\*0, \*1}$ are continuous.
...
although they could be easily taken into account.
...
It seems obvious to instead use interpolation approaches based sparse grids.
