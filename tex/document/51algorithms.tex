...
(see
\cref{tbl:optimizationMethods},
\cref{fig:optimizationMethodsGradientFree}, and
\cref{fig:optimizationMethodsGradientBased}),
...
\newcommand*{\optImage}[1]{%
  \raisebox{-0.5\height}{\includegraphics{optimizationMethods_#1}}%
}
...
\begin{figure}
  ...
  \label{fig:optimizationMethodsGradientFree}%
\end{figure}
...
\begin{figure}
  ...
  \label{fig:optimizationMethodsGradientBased}%
\end{figure}
