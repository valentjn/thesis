...
\begin{figure}
  ...
  \hfill%
  \subcaptionbox{%
    G04Sq (bivariate projection over $\xscaled[3]$ and $\xscaled[5]$
    onto $\xscaled[t] = \xoptscaled[t]$ for $t = 1, 2, 4$)%
  }[72mm]{%
...
The parameter domain of some test problems have been slightly translated
