      ...
      \For{$j = 1, \dotsc, d$}
        ...
        \For{$\lisetpole \in \eqclasses{\liset}{\samepole{t_j}}$}
          \State{%
            ...
            \Bigl[(\linout[(j-1)]{\*k})_{\*k \in \lisetpole}\Bigr]$%
          }
...
\begin{proof}
  ...
  \begin{equation}
    ...
    %\Bigl[(\linout[(j)]{\*k})_{\*k \in \lisetpole}\Bigr])_{k'_{t_j}}
    %= ((\linout[(j-1)]{\*k})_{\*k \in \lisetpole})_{k'_{t_j}}
    = \Bigl((\upopuv{t_j}{\lisetpole})^{-1}
    \Bigl[(\linout[(j)]{\*k''})_{\*k'' \in \lisetpole}\Bigr]
    \Bigr)_{k'_{t_j}}
