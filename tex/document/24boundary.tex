...
\begin{definition}[regular sparse grid with coarse boundary]
  ...
  \begin{equation}
    ...
    \begin{split}
      ...
      &\bigl(\{\*l \in \natz^d \setminus \nat^d \mid
      \normone{\vecmax(\*l, \*1)} \le n-b+1\} \cup \{\*0\}\bigr).
    \end{split}
  \end{equation}
...
\begin{restatable}[invariant of coarse boundary SG generation]{%
  proposition%
}{%
  ...
  \begin{equation}
    ...
    \begin{split}
      ...
      &\hphantom{{}={}} \bigl(\{\*l \in \natz^t \setminus \nat^t \mid
      \normone{\vecmax(\*l, \*1)} \le n-d+t-b+1\} \cup \{\*0\}\bigr).
    \end{split}
  \end{equation}
\end{restatable}
\begin{proof}
...
\end{proof}
\begin{shortcorollary}[correctness of coarse boundary SG generation]
