...
\begin{figure}
  ...
  \newcommand*{\drawcircle}[2][]{
    ...
    \IfStrEq{#1}{noArrow}{}{
      ...
      \draw[-{Stealth[length=2mm,width=2mm]}] (myCircle#2) to[
  ...
  \begin{tikzpicture}
    ...
    \begin{scope}[rotate=-130]
      ...
      \draw[-{Stealth[length=2mm,width=2mm]}] (optimize) to[
        bend left=30,
      ] (myCircle30);
      \draw[-{Stealth[length=2mm,width=2mm]}] (myCircle30) to[
        bend left=30,
      ] (interpolate);
      \draw[-{Stealth[length=2mm,width=2mm]}] (interpolate) to[
        bend left=30,
