...
The \texttt{optimize} is given as \cref{alg:financeOptimize}.
...
with $\state_{t+1}^\mathrm{in} := \vecmin(\vecmax(\state_{t+1}, \*0), \*1)$
...
Since the hierarchical B-splines enable us to
...
we can move on to step 2 of the general structure of our method
