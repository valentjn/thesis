...
\begin{table}
  ...
  \begin{tabular}{%
    ...
    \toprulec
    \pnst{\forceT}& \pnst{\armT}& \pnst{\activationT}\\
    \pnst{\forceB}& \pnst{\armB}& \pnst{\activationB}\\
    \pnst{\forceL}& \pnst{\armL}& \pnst{\elbowangle}\\
    \bottomrulec
  \end{tabular}%
...
\begin{equation}
  ...
  := (
    ...
    \activation \gamma_\mathrm{M} \mat{S}_\mathrm{active}
  ) (1 - \gamma_\mathrm{ST}),
\end{equation}
...
$\activation \in \clint{0, 1}$ is the \term{activation level} of the
