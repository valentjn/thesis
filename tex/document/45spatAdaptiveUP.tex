...
\begin{proposition}[%
  sufficient condition for the convergence of \ref{alg:iterativeRefinement}%
]
...
\begin{figure}
  ...
  \caption[%
    ...
    Analogously,
    \textcolor{C2!90!black}{yellow points} are third-order chain points.
...
linear Lagrange polynomial of level $0$:%
\footnote{%
