...
which is known as the \term{curse of dimensionality.}
...
\multicite{Pflueger10Spatially,Valentin14Hierarchische} studies suggest that
using \term{B-splines} as sparse grid basis functions help to improve results.
...
In \cref{chap:30BSplines}, we define hierarchical B-splines for sparse grids.
...
\term{(not-a-knot conditions)} into the hierarchical B-spline bases,
