...
\begin{proof}[Proof (sketch)]
  ...
  \begin{subequations}
    ...
    \end{align}
  \end{subequations}
  We will prove that first of the two summands in
...
($j = 1, \dotsc, m$)
and no full grid set is contained is another, i.e.,
...
In \cref{chap:a0proofs}, we prove that the algorithm satisfies
