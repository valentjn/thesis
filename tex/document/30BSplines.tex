...
\initial{-0.05em}{P}{roblematically,}
...
(which include the piecewise polynomials by Bungartz).
...
Researchers have applied B-splines in
...
\input{document/31standardBSplines}
\input{document/32notAKnot}
