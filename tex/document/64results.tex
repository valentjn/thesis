...
we will analyze the errors of types \ref{item:topoOptErrorInterpolation} and
\ref{item:topoOptErrorCholesky} (\cref{sec:643interpolation})
and of type \ref{item:topoOptErrorOptimization} (\cref{sec:644optimization}).
