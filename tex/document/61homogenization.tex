...
Let $\objdomain \subset \real^{\dimdomain}$ be the optimization domain.%
\footnote{%
...
$\displacement_{\densglobal}\colon \objdomain \to \real^{\dimdomain}$
...
%To be able to discretize the domain $\objdomain \subset \real^{\dimdomain}$
%more easily,
