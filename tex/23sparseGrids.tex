...
%For example for hat functions $\bspl{\ßl,\ßi}{1}{}$, the grid should contain
...
%choice of $\liset$.
For example when working with hat functions $\bspl{\ßl,\ßi}{1}{}$,
