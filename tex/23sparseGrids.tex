...
$f|_{\bndrydomain{\clint{\ß0,\ß1}}} \equiv 0$,
...
\begin{equation}
  \normLtwo{f - f_{n,d}^{\sparse,1}} = \landauO{\ms{n}^2 (\log_2 \ms{n}^{-1})^{d-1}},
\end{equation}
...
\begin{equation}
  \sgspace
  = \bigoplus_{\ßl \in L} \hs{\ßl},\qquad
  \sgset
  = \bigdotcup_{\ßl \in L} \{\vgp{\ßl,\ßi} \mid \ßi \in \his{\ßl}\},
\end{equation}
...
\end{equation}
where the $\interpcoeff{\ßl,\ßi} \in \RR$ ($\ßi = \ß0, \dotsc, \ß2^\ßl$)
...
\begin{equation}
  \sgspace
  = \spn\{\basis{\ßl,\ßi} \mid (\ßl,\ßi) \in \lis\},\qquad
  \sgset
  = \{\vgp{\ßl,\ßi} \mid (\ßl,\ßi) \in \lis\},
\end{equation}
where $\lis$ is a finite set of level-index pairs $(\ßl,\ßi)$
with $\ßl \in \NNz^d$ and $\ßi \in \his{\ßl}$.
Algorithms for sparse grids often make specific assumptions about $\lis$.
...
%  \forall_{(\ßl,\ßi) \in \lis}
%  \fa{\{t = 1, \dotsc, d \mid l_t \ge 1\}}{(\ßl',\ßi') \in \lis},\quad
%  \ßl' := \ßl - \ße_t,\quad
%  i_{t'}' :=
%  \begin{cases}
