...
\iftoggle{partialCompileMode}{
  ...
  \newglossarystyle{longraggedfixed}{%
    ...
    % only print number of first occurrence
    % (we use \glsresetall at the beginning of each chapter and section
    % to redisplay the full versions of acronyms, but this adds all the
    % page numbers of an occurrence after a new chapter/section to the
    % table)
    \renewcommand*{\glossaryentrynumbers}[1]{%
      \newif\iffirstpagenumber%
      \firstpagenumbertrue%
      ##1\gls@save@numberlist{##1}%
    }
    \renewcommand*{\glsnumberformat}[1]{%
      \iffirstpagenumber%
        \glshypernumber{##1}%
        \firstpagenumberfalse%
      \fi%
    }
    \renewcommand*{\delimN}{}%
  }
  ...
  \newcommand*{\makecommandnotation}[4]{%
    ...
    \apptocmd{#1}{\ifinglossary\else\usenotation{#2}\fi}{}{}%
  }
  ...
  % deprecated
  \newcommand*{\newgsymbol}[3]{%
    \newglossaryentry{#1}{sort={#1},name={#2},description={\textcolor{red}{#3}},text={}}%
  ...
  \newcommand*{\newgacronym}[3]{%
    ...
    \newnamecommand{#1}{\glsfieldgdef{#1}{myused}{true}\gls{#1}\xspace}%
    \newnamecommand{#1s}{\glsfieldgdef{#1}{myused}{true}\glspl{#1}\xspace}%
    \newnamecommand{#1c}{\glsfieldgdef{#1}{myused}{true}\Gls{#1}\xspace}%
    \newnamecommand{#1sc}{\glsfieldgdef{#1}{myused}{true}\Glspl{#1}\xspace}%
  }
  
  % hide specific acronyms (that are only used once) in glossary
  \newignoredglossary{hidden}
  \newcommand*{\hidegacronym}[1]{\glsmoveentry{#1}{hidden}}
  ...
  % warn for every symbol that has not been used i
  \AtEndDocument{%
