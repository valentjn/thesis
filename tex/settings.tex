...
% patch easy-todo such that nag warning goes away (unmatched flushright);
% in addition, this removes the ugly "P." header
%\makeatletter
%\renewcommand*{\listoftodos}{%
%  \ifthenelse{\equal{\@todoenable}{true}}{%
%    \addchap{\texorpdfstring{\todocolor{}}{}List of TODOs}%
%    \todocolor\@starttoc{lod}%
%  }{}%
%}
%\makeatother
%
%% include position in TODOs
%\let\oldtodoii\todoii
%\renewcommand*{\todoii}[2]{\oldtodoii{#1}{\thesubsection{} \currentname: #2}}
