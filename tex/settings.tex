...
% small-caps sans-serif page header
\setkomafont{pageheadfoot}{\normalfont\sffamily\footnotesize\normalcolor\scshape}

% ... but don't use small-caps for page number in footer
\setkomafont{pagenumber}{\normalfont\sffamily\normalsize}

% format float captions
\DeclareCaptionLabelFormat{mylabelformat}{%
  \sffamily\bfseries\footnotesize{\scshape\MakeUppercase{#1}} #2%
}
\captionsetup{
...
\DeclareCaptionLabelFormat{mysublabelformat}{%
  \sffamily\bfseries\footnotesize{\scshape\MakeUppercase{#2}}%
}
\captionsetup[sub]{
  % use custom label format
