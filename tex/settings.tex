...
\RedeclareSectionCommand[
  ...
  beforeskip=-1.75ex plus -.5ex minus .1ex,
]{section}
...
\mdfdefinestyle{thmmdfstyle}{
  ...
  backgroundcolor=mittelblau!20,
  extra={%
    \draw[mittelblau,line width=4pt]
    ($(O)+(2pt,0pt)$) -- ($(O|-P)+(2pt,0pt)$);%
  },
  % mdframed documentation lies about the default value of splitbottomskip,
  % claims it is 0pt when in reality it's 10pt
  splittopskip=15pt,
  splitbottomskip=5pt,
}
