...
\mdfdefinestyle{floatmdfstyle}{
  ...
  apptotikzsetting={%
    ...
    % which some printer and printing services cannot handle
    ...
    \tikzset{
      ...
      mdfshadow/.style={
        ...
        drop shadow={line width=0.0mm,draw=black!27,fill=black!27},
        drop shadow={line width=0.0mm,draw=black!30,fill=black!30,
                     shadow xshift=0.85mm,shadow yshift=-0.85mm,},
        drop shadow={line width=0.0mm,draw=black!33,fill=black!33,
                     shadow xshift=0.70mm,shadow yshift=-0.70mm,},
        drop shadow={line width=0.0mm,draw=black!36,fill=black!36,
                     shadow xshift=0.35mm,shadow yshift=-0.35mm,},
        drop shadow={line width=0.0mm,draw=black!39,fill=black!39,
...
\newcommand*{\headerrowcolor}{mittelblau}
\newcommand*{\headerrowtextcolor}{white}
...
\iftoggle{flipBookMode}{
  ...
  \AddEverypageHook{%
    % start flip book after dedication
    % (two pages book cover + two pages title page + two pages dedication
    % = six pages)
    \flipbookindex=\numexpr(\thecurrentpagenumber-6)/2\relax%
