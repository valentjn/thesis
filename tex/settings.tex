...
% undefine \listoftheorems (thmtools's thm-listof.sty is unfortunately
% a little buggy, as it causes the flip book images to jump;
% using KOMA-Script for all lists is more consistent and less error-prone)
\let\listoftheorems\undefined
\DeclareNewTOC[
  type=theorem,
  name=Theorem,
...
\addtotheorempostheadhook{%
  \addxcontentsline{lop}{theorem}{\csname ll@\thmt@envname\endcsname}%
}
\makeatother
