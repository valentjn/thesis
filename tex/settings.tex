...
% left-align chapter title, use single spacing
\newcommand*{\chaptertitle}[1]{%
  \leavevmode\smash{%
    \begin{minipage}[b]{0.85\linewidth}%
      \raggedchapter\singlespacing#1%
    \end{minipage}%
  }%
}
...
% separate floats from text with a dotted line
\newcommand*{\topfigrule}{\textcolor{black}{\vskip1.2ex\noindent\dotfill}}
\newcommand*{\botfigrule}{\textcolor{black}{\noindent\dotfill\vskip1.2ex}}
