...
% ======================================================================
% Tables of Contents, Figures, Tables, and Algorithms
% ======================================================================

% remove indentation for lists of figures and algorithms
...
% use single spacing in tables of contents, figures, tables, and algorithms
\AfterTOCHead[toc]{\begin{spacing}{1}}
\AfterStartingTOC[toc]{\end{spacing}}
\AfterTOCHead[lof]{\begin{spacing}{1}}
\AfterStartingTOC[lof]{\end{spacing}}
\AfterTOCHead[lot]{\begin{spacing}{1}}
\AfterStartingTOC[lot]{\end{spacing}}
\AfterTOCHead[loa]{\begin{spacing}{1}}
\AfterStartingTOC[loa]{\end{spacing}}
...
\renewenvironment{proof}[1][Proof]{%
  ...
  {%
    ...
    \textls*{\MakeUppercase{#1}}\hspace{1em}%
  }%
}{\hfill\qedsymbol}
...
\iftoggle{partialCompileMode}{
  ...
  \newcommand*{\newgacronym}[3]{%
    ...
    \newnamecommand{#1s}{#2s\xspace}%
    \newnamecommand{#1c}{\makefirstuc{#2}\xspace}%
    \newnamecommand{#1sc}{\makefirstuc{#2}s\xspace}%
  }
  ...
  % \newnotationcommand[numberOfArgs]{\commandName}{commandDefinition}
  %   {sortKey}{entrySymbol}{entryText}
  ...
  \newcommand*{\newgacronym}[3]{%
    \newacronym[sort={Ü#1},description={\makefirstuc{#3}}]{Ü#1}{#2}{#3}%
    \glsfieldgdef{Ü#1}{myisacronym}{true}%
    \newnamecommand{#1}{\glsfieldgdef{Ü#1}{myused}{true}\gls{Ü#1}\xspace}%
    \newnamecommand{#1s}{\glsfieldgdef{Ü#1}{myused}{true}\glspl{Ü#1}\xspace}%
    \newnamecommand{#1c}{\glsfieldgdef{Ü#1}{myused}{true}\Gls{Ü#1}\xspace}%
    \newnamecommand{#1sc}{\glsfieldgdef{Ü#1}{myused}{true}\Glspl{Ü#1}\xspace}%
  }
