...
The fundamental splines $\parentfcn[p,\fs]$ of low degrees $p$ and
...
\begin{figure}
  ...
  \caption[%
    ...
    The fundamental spline $\parentfcn[p,\fs]$ \emph{\textcolor{C0}{(blue)}}
    ...
    The absolute values of the fundamental spline $\parentfcn[p,\fs]$ and
...
\begin{table}
  ...
  \caption[%
    ...
    the fundamental spline $\parentfcn[p,\fs]$ and
    its coefficients $\fundsplcoeff{k}{p}$, i.e.,
    $\fa{x \in \real}{|\parentfcn[p,\fs](x)| \le \beta_p (\gamma_p)^{-|x|}}$
    and
