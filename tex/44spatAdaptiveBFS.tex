...
\begin{proof}
  We have $\regsgspace{n}{d}{} \supset \regsgspace{n}{d}{\hft}$ as
  ...
  To prove that $\regsgspace{n}{d}{} \subset \regsgspace{n}{d}{\hft}$,
  we show that the dimension of $\regsgspace{n}{d}{\hft}$
...
is chosen such that \eqref{eq:tiftDefinition} golds,
