...
\hidenextnotation
\newnotationcommand{\densglobal}{\tilde{\varrho}}{Äρ}{$\densglobal$}{
  Global density fcn.
}

\hidenextnotation
\newnotationcommand{\denscell}{\varrho}{Äρ}{$\denscell$}{
  Micro-cell density fcn.
}

\hidenextnotation
\newnotationcommand{\compliance}{J}{Jρ}{$\compliance(\densglobal)$}{
  Compliance fcn.
}
