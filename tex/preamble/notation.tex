...
\hidenextnotation
\newnotationcommand{\activation}{\beta}{Äβ}{$\activation$}{
  Muscle activation
}

\hidenextnotation
\newnotationcommand{\activationT}{\beta_\mathrm{T}}{ÄβT}{$\activationT$}{
  Triceps activation
}

\hidenextnotation
\newnotationcommand{\activationB}{\beta_\mathrm{B}}{ÄβB}{$\activationB$}{
  Biceps activation
}
