...
\hidenextnotation
\newnotationcommand{\elbowangle}{\theta}{Äθ}{$\elbowangle$}{
  Elbow angle
}

\hidenextnotation
\newnotationcommand{\forcetriceps}{\*F_\mathrm{T}}{FT}{$\forcetriceps$}{
  Triceps force
}

\hidenextnotation
\newnotationcommand{\forcebiceps}{\*F_\mathrm{B}}{FB}{$\forcebiceps$}{
  Biceps force
}

\hidenextnotation
\newnotationcommand{\forceload}{\*F_\mathrm{L}}{FL}{$\forceload$}{
  Load force
}

\hidenextnotation
\newnotationcommand{\armtriceps}{r_\mathrm{T}}{rT}{$\armtriceps$}{
  Triceps lever arm
}

\hidenextnotation
\newnotationcommand{\armbiceps}{r_\mathrm{B}}{rB}{$\armbiceps$}{
  Biceps lever arm
}

\hidenextnotation
\newnotationcommand{\armload}{r_\mathrm{L}}{rL}{$\armload$}{
  Load lever arm
}
