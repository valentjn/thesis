...
\newnotation{Ëtr}{$\mat{A}^\tr$}{
  Transpose of the matrix $\mat{A}$
}
...
\newnotationcommand[2]{\gradient}{\mathop{\*\nabla\!_{#1}} #2}{Ögradient}{%
  $\gradient{\*x}{f}$%
}{
...
\newcommand*{\etensorentry}[1]{E_{#1}}
\newcommand*{\etensorsgintp}{\mat{E}^\sparse}
\newcommand*{\etensorentrysgintp}[1]{E_{#1}^\sparse}
\newcommand*{\etensorcholsgintp}{\mat{E}^{\chol,\sparse}}
