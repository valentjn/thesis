...
of the form $\setsize{\sgset} = \{\vgp{\ßl,\ßi} \mid (\ßl, \ßi) \in \lis\}$,
where $\lis$ is a set of level-index pairs $(\ßl, \ßi)$ with $\ßl \in \NNz$
and $\ßi \in \his{\ßl}$ such that $N := \setsize{\sgset} = \setsize{\lis} < \infty$
(see \cref{sec:233spatiallyAdaptiveSG}).
The \term{hierarchization problem} is finding
\term{hierarchical surpluses}
$(\surplus{\ßl',\ßi'})_{(\ßl',\ßi') \in \lis} \in \RR^N$ such that
\begin{equation}
  \label{eq:hierarchizationProblem}
  \sum_{\mathclap{(\ßl', \ßi') \in \lis}} \surplus{\ßl',\ßi'}
  \basis{\ßl',\ßi'}(\vgp{\ßl,\ßi}) = f_{\ßl,\ßi}
  \quad\text{for all}\quad
  (\ßl, \ßi) \in \lis,
\end{equation}
where $(f_{\ßl,\ßi})_{(\ßl,\ßi) \in \lis} \in \RR^N$ is a given set of
...
%}
\begin{equation}
  \ßu = (u_{\ßl,\ßi})_{(\ßl,\ßi) \in \lis} \in \RR^N,\quad
  \ßy = (y_{\ßl,\ßi})_{(\ßl,\ßi) \in \lis} \in \RR^N,
\end{equation}
...
\begin{subequations}
  ...
  \begin{equation}
    L = A^{-1},\quad
    A = (\basis{\ßl',\ßi'}(\vgp{\ßl,\ßi}))_{(\ßl,\ßi),(\ßl',\ßi') \in \lis},\quad
    \ßu = (f_{\ßl,\ßi})_{(\ßl,\ßi) \in \lis},\quad
    \ßy = (\surplus{\ßl',\ßi'})_{(\ßl',\ßi') \in \lis}.
  \end{equation}
  ...
  \begin{equation}
    \ßy = L[\ßu]
    \quad\iff\quad
    A \cdot (\surplus{\ßl',\ßi'})_{(\ßl',\ßi') \in \lis}
    = (f_{\ßl,\ßi})_{(\ßl,\ßi) \in \lis}.
  \end{equation}
\end{subequations}
...
Consequently,
we can regard $\lis$ as a subset $\{\ßk \mid \ßx_\ßk \in \sgset\}$
of $\NN^d$.
