...
\begin{proof}
  ...
  \begin{equation}
    \sum_{l'=0}^l \sum_{i' \in \his{l'}} \surplus{l',i'} \basis{l',i'}^p
    \equiv 0
  \end{equation}
  ...
  \begin{equation}
    ...
    \sum_{i \in \his{l}} \surplus{l,i} \basis{l,i}^p
    =: g_1 \equiv g_2 :=
    -\sum_{l'=0}^{l-1} \sum_{i' \in \his{l'}} \surplus{l',i'} \basis{l',i'}^p.
  \end{equation}
  ...
  \begin{alignat}{2}
    \sum_{i \in \his{l}} \surplus{l,i} (-1)^{k-1} \binom{p}{k-1}
    &= \sum_{i \in \his{l}} \surplus{l,i} (-1)^k \binom{p}{k},\quad
    &&i' \in \his{l},\quad
    k := \frac{p+1}{2} + i' - i.
  \end{alignat}
