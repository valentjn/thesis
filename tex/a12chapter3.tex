...
\begin{proof}
  ...
  \begin{equation}
    \sum_{l'=0}^l \sum_{i' \in I_{l'}} \alpha_{l',i'} \basis{l',i'}^p
    \equiv 0
  \end{equation}
  ...
  \begin{equation}
    ...
    \sum_{i \in I_l} \alpha_{l,i} \basis{l,i}^p
    =: g_1 \equiv g_2 :=
    -\sum_{l'=0}^{l-1} \sum_{i' \in I_{l'}} \alpha_{l',i'} \basis{l',i'}^p.
  \end{equation}
  The right-hand side $g_2$ is smooth in every grid point
  $\gp{l,i}$ ($i \in I_l$) of level $l$,
  since these grid points are not knots of the hierarchical B-splines
  $\basis{l',i'}^p$ ($i' \in I_{l'}$) of level $l' < l$.
