...
\begin{proof}
  ...
  For $l = 0$, the B-splines $\hierbspl{0,i'}{p}{}$ with $i' \in \{0, 1\}$
  are linearly independent.
  For the induction step $(l-1) \to l$, let
  \begin{equation}
    \sum_{l'=0}^l \sum_{i' \in \hiset{l'}} \surplus{l',i'} \hierbspl{l',i'}{p}{}
    \equiv 0
  \end{equation}
  ...
  \begin{equation}
    ...
    \sum_{i \in \hiset{l}} \surplus{l,i} \hierbspl{l,i}{p}{}
    =: g_1 \equiv g_2 :=
    -\sum_{l'=0}^{l-1} \sum_{i' \in \hiset{l'}} \surplus{l',i'} \hierbspl{l',i'}{p}{}.
  \end{equation}
  ...
  $\hierbspl{l',i'}{p}{}$ ($i' \in \hiset{l'}$) of level $l' < l$.
  ...
  \begin{alignat}{3}
    ...
    \partialdiff_-^p \hierbspl{l,i}{p}{}(\gp{l,i'})
    &= \sum_{i \in \hiset{l}} \surplus{l,i}
    \partialdiff_+^p \hierbspl{l,i}{p}{}(\gp{l,i'}),\quad
    &&i' \in \hiset{l},
  \end{alignat}
  ...
  Thus, the hierarchical functions $\hierbspl{l',i'}{p}{}$
