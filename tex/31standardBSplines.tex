...
\begin{corollary}[nodal B-spline space]
  ...
  The restricted nodal B-splines $\restrictfcn{\basis{l,i}^p}{\restrictedspldomain{l}{p}}$
  ($i = 0, \dotsc, 2^l$)
  of level $l \in \natz$ are
...
\begin{proof}
  ...
  differentiable.
  \Cref{prop:splineSpace} implies $\basis{l',i'}^p \in \restrictedsplspace{l}{p}$
  and from \cref{cor:nodalBSplineSpace}, it follows
  $\basis{l',i'}^p \in \restrictspace{\ns{l}^p}{\restrictedspldomain{l}{p}}$.
