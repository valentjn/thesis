...
\newgsymbol{x01}{$\chi_A$}{Characteristic function of the set $A \subset \real$}%
...
\begin{equation}
  ...
  \begin{cases}
    ...
    \chi_{\hopint{0, 1}}(x),&p = 0,
  \end{cases}
\end{equation}
where $\chi_{\hopint{0, 1}}$ is the characteristic function of
...
\begin{definition}[non-uniform B-splines]
  ...
  \begin{equation}
    ...
    \begin{cases}
      ...
      \chi_{\hopint{\xi_k, \xi_{k+1}}}(x),&p = 0.
    \end{cases}
  \end{equation}
\end{definition}
