...
\cite{Pflueger10Spatially,Valentin14Hierarchische,Valentin16Hierarchical}
to define hierarchical B-splines
starting from the well-known nodal B-spline basis
\cite{Hoellig03Finite,Hoellig13Approximation}.
...
(as we will see in \cref{sec:44spatAdaptive}).
Therefore, and
