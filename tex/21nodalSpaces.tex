...
\newgsymbol{fl}{$\fgintp{l}$}{Interpolant of $f$ in $\ns{l}$}%
...
\newgsymbol{01!c}{$\clint{\ß0, \ß1}$}{%
  Unit hypercube $:= \clint{0, 1}^d := \{x \in \RR \mid 0 \le x \le 1\}^d$%
}
...
\newgsymbol{Vl!}{$\ns{\ßl}$}{Multivariate nodal space of level $\ßl$}%
...
\end{equation}
\newgsymbol{ab!}{$\clint{\ßa, \ßb}$}{%
  Hypercube $:= \clint{a_1, b_1} \times \dotsb \times \clint{a_d, b_d}$%
}%
...
\end{equation}
\newgsymbol{fl!}{$f_\ßl$}{Interpolant of $f$ in $\ns{\ßl}$}%
...
in the nodal space $\ns{\ßl}$ with $f_\ßl\colon \clint{\ß0, \ß1} \to \RR$ satisfying
\begin{equation}
