...
\begin{proof}
  ...
  \begin{equation}
    ...
    \left(\sum_{i_d=0}^{2^{l_d}} c_\ßi \varphi_{l_d,i_d}(\gp{l_d,i_d'})\right) \dotsb
    \varphi_{l_2,i_2}(\gp{l_2,i_2'})\right) \varphi_{l_1,i_1}(\gp{l_1,i_1'})
    = 0.
  \end{equation}
