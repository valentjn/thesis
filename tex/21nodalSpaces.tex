...
\end{equation}
where $\interpcoeff{\ßi} \in \RR$ and
...
\end{lemma}
\begin{proof}
  Assume that $\interpcoeff{\ßi} \in \RR$ are chosen in \eqref{eq:interpFullGridMV}
...
\end{proof}
The lemma is equivalent to the statement that the coefficients $\interpcoeff{\ßi} \in \RR$
