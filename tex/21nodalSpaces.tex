...
\begin{figure}
  \subcaptionbox{%
    Basis functions $\hierbspl{l,i}{1}{}$ ($i = 0, \dotsc, 2^l$)
...
$\ms{\ßl} := \ß2^{-\ßl} = (\ms{l_1}, \dotsc, \ms{l_d})$.
...
\begin{proof}
  ...
  we can evaluate \eqref{eq:interpFullGridMV} at $\gp{\ßl,\ßi'}$ to obtain
  \begin{equation}
    \sum_{i_1=0}^{2^{l_1}}
...
\begin{equation}
  \fgset{\ßl}
  := \{\gp{\ßl,\ßi} \mid \ßi = \ß0, \dotsc, \ß2^{\ßl}\}.
\end{equation}
\usenotation{n}
