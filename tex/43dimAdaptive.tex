...
\begin{restatable}[identical values in equivalence classes of $\eq$]{%
  shortlemma%
}{%
...
\begin{restatable}[characterization of the equivalence classes of $\eq$]{%
  lemma%
}{%
